...
class Application():
    ...
    def open(self):
        ...
        #Convierte la ventana en transitoria respecto a la raíz
        #Si se minimiza la raíz también será minimizada
        self.dialog.transient(master=self.app)

        #El método grab_set() asegura que sólo se trabaje en la actual ventana
        #es necesario cerrar para trabajar con otra diferente
